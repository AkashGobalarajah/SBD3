...
libraries <- c("readr", "tidyverse", "dlookr", "ggplot2", "xgboost", "dplyr", "caret", "doParallel", "mltools", "knitr")
...
importance <- varImp(model_nn_3, scale = FALSE)
...
# Print the feature importance as a table
kable(importance_matrix, caption = "Feature Importance XGBoost Model")
```
