...
When we use print to look at the model we can see, that it used the size 2 and the decay of 1. Because of that we can adjust our grid to only use these values. This will speed up our work.