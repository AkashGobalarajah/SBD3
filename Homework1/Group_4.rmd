...
libraries <- c("readr", "tidyverse", "dlookr", "ggplot2", "xgboost", "dplyr", "caret", "doParallel", "mltools")
...
resampling_results <- model_nn$resample
...
model_xgb <- xgboost(
  data = as.matrix(data_scaled_train[, -64]), # excluding the target variable
  label = data_scaled_train$wage,
...
predictions_xgb <- predict(model_xgb, as.matrix(data_scaled_test[, -64]))
